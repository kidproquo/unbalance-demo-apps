#!/usr/bin/env python3
"""
MCP Server for Minimal RFC Unbalance Detection Monitoring
...
@mcp.tool(name="rfc_get_performance_metrics")
def get_performance_metrics() -> dict:
    """
    Get the latest performance metrics from the Minimal RFC unbalance detection system.
...
@mcp.tool(name="rfc_get_recent_detections")
...
@mcp.tool(name="rfc_get_system_status")
def get_system_status() -> dict:
    """
    Get the overall status of the Minimal RFC unbalance detection system.
